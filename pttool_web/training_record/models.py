...
class TbRecord(models.Model):
    ...
    ptrymd = models.TextField(blank=True, null=True)
    ...
    ptrsessionf = models.CharField(max_length=3, blank=True, null=True)
    ptrsessionl = models.CharField(max_length=3, blank=True, null=True)
    ptrfrequency = models.CharField(max_length=3, blank=True, null=True)
    ...
    ptrmpcnt = models.CharField(max_length=3, blank=True, null=True)
